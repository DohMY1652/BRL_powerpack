...
double PneumaticCT::solenoid_valve(double P_inlet, double P_outlet, double signal, double type, double num)
{
    ...
    double Cdkx;
    if (type == 1) {
        double Cpos1 = 0.00128710461056791;
        double Cpos2 = 0.000200689151920720;
        double Cpos3 = 3.04496414459699e-7;

        Cdkx = Cpos1*current - Cpos2 + Cpos3*(Pin - Patm)*S > 0 ? Cpos1*current - Cpos2 + Cpos3*(Pin - Patm)*S : 0;
    } else {
        double Cneg1 = 0.00108331088516356;
        double Cneg2 = 0.000160006957728170;
