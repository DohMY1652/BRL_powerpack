...
PneumaticSimulator::PneumaticSimulator() 
{
    ...
    std::cout << pneumaticCT -> max_volume << std::endl;
    double Vmax = pneumaticCT -> max_volume;
    double air_mass = 1000*ATM*Vmax/(1000*R*T_);
    std::cout << air_mass << std::endl;
...
void PneumaticSimulator::set_init_env(double pos_press, double neg_press)
{
    ...
    xk0[4] = 6*(pneumaticCT -> volume_ratio);
    xk0[5] = 6;
